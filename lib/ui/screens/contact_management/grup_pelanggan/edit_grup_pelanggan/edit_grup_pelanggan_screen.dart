...
import '../../../../../../data/blocs/contact_management/grup_pelanggan/edit_grup/edit_grup_pelanggan_bloc.dart';
import '../../../../../../data/blocs/contact_management/grup_pelanggan/edit_grup/edit_grup_pelanggan_state.dart';
...
import '../../../../widgets/form_with_label_widget.dart';
import '../../kontak_pelanggan/edit_kontak_pelanggan/edit_kontak_pelanggan_screen.dart';

class EditGrupPelangganScreen extends StatefulWidget {
  const EditGrupPelangganScreen({Key? key, required this.data}) : super(key: key);
  final GrupPelanggan data;

  @override
  State<EditGrupPelangganScreen> createState() => _EditGrupPelangganScreenState();
}

class _EditGrupPelangganScreenState extends State<EditGrupPelangganScreen> {
  late  EditGrupPelangganBloc _bloc;
  ...
  void initState() {
    ...
    _bloc = EditGrupPelangganBloc()..init(widget.data);
  }
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
                    ...
                    return SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                            ...
                            builder: (context, state) {
                              if (state
                                ...
                                return Center(
                                  child: TextInter(
                                    text:
                                        "${state.data.length} KONTAK DITEMUKAN",
                                    size: 13,
                          ...
                          BlocBuilder<EditGrupPelangganBloc,
                              EditGrupPelangganState>(
                            builder: (context, state) {
                              return Padding(
            ...
            BlocBuilder<EditGrupPelangganBloc, EditGrupPelangganState>(
              builder: (context, state) {
                  ...
                  return Align(
                    ...
                    child: Container(
                      ...
                      child: PrimaryButton(
                        ...
                        forceAction: true,
                        onPressed: () {
                          context.read<GrupPelangganBloc>().editGrup(_bloc.createObj());
            ...
            child: FormWithLabel(
              ...
              iconSuffix: Container(
                ...
                decoration: const BoxDecoration(
                  border:
                      Border(left: BorderSide(color: PaletteColor.textGrey)),
                ),
                child: GestureDetector(
                      ...
                      builder: (context) {
                        return AlertDialog(
                          ...
                          content: SingleChildScrollView(
                            child: ColorPicker(
                              enableAlpha: false,
                              pickerColor: _bloc.selectedColor ?? Colors.white,
                              onColorChanged: _bloc.changeTempColor,
                            ),
                          ),
                          actions: <Widget>[
                            PrimaryButton(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      border:
                          Border.all(color: PaletteColor.textGrey, width: 1.3),
