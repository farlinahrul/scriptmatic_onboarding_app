...
import 'edit_grup_pelanggan_bloc.dart';
import 'edit_grup_pelanggan_state.dart';

class EditGrupPelangganScreen extends StatelessWidget {
  EditGrupPelangganScreen({Key? key, required this.data}) : super(key: key);
  final GrupPelanggan data;
  late final EditGrupPelangganBloc _bloc = EditGrupPelangganBloc();
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();

  late KontakPelangganBloc _blocKontak;
  late final GrupPelangganBloc _blocGrup;
                  ...
                  return Align(
                    ...
                    child: Container(
                      ...
                      child: PrimaryButton(
                        ...
                        forceAction: true,
                        onPressed: () {
                          _blocGrup.editGrup(_bloc.createObj());
