...
class ImportKontakScreen extends StatelessWidget {
  ImportKontakScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: "Import Kontak"),
      body: Stack(
        children: [
          Column(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return ContactTileWithCheckbox(
                                  ...
                                  onChanged: (isSelected) {
                                    _bloc.changeStatusItem(contact, isSelected);
                                  },
                                  onTap: () {},
                    ...
                    child: PrimaryButton(
                      ...
                      onPressed: () {
                        if (_bloc.listDataTemp.isNotEmpty) {
                          _bloc
                              .addAllData((val) => _blocKontak.addContact(val));
                        }
