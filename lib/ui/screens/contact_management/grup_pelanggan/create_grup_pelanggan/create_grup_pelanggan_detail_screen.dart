...
import '../../../../../../data/blocs/contact_management/grup_pelanggan/create_grup/create_grup_pelanggan_state.dart';
import '../../../../../../data/blocs/contact_management/grup_pelanggan/grup_pelanggan_bloc.dart';
import '../../../../../../models/kontak_pelanggan.dart';

class CreateGrupPelangganDetailScreen extends StatefulWidget {
  const CreateGrupPelangganDetailScreen({Key? key}) : super(key: key);

  @override
  State<CreateGrupPelangganDetailScreen> createState() =>
      _CreateGrupPelangganDetailScreenState();
}

class _CreateGrupPelangganDetailScreenState
    extends State<CreateGrupPelangganDetailScreen> {
                ...
                child: PrimaryButton(
                  ...
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      context
                          .read<GrupPelangganBloc>()
                          .addData(_bloc.createObj());
